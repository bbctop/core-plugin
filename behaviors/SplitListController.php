 ...
 */
class SplitListController extends ControllerBehavior
{
    /**
    ...
    public function listRender($definition = null)
    {
        ...
        if(!empty($listConfig->splitLayout)) {
            $this->addJs(['$/bbctop/core/assets/split/vendor/split.min.js','$/bbctop/core/assets/split/js/bbctop.split.js'], 'split');
            $this->addCss(['$/bbctop/core/assets/split/css/split.css'], 'split');
        }
