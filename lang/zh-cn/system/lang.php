...
return [
    'installer' => [
        ...
        'license_thanks_comment' => '感谢您成为BBCTOP客户！',
        'license_expired_comment' => '许可证未支付或已过期。请访问 bbctop.com 获取许可证。',
    ...
    'mail_brand' => [
        ...
        'sample_template' => [
            ...
            'panel' => '这个面板有多棒?',
            'more' => '更多文字',
            'promotion' => '优惠券代码：BBCTOP',
            'subcopy' => '这是电子邮件的副本',
            'thanks' => '谢谢, BBCTOP CMS',
        ],
        'fields' => [
